        ...
        <Dialog open={open} onOpenChange={setOpen}>
          ...
          <DialogContent className="max-w-md">
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-2">
                <Label>Apelido para o link</Label>
                <Input
                  value={form.slug}
                ...
                <p className="text-xs text-muted-foreground">
                  Usado no link enviado ao aluno: /r/&#123;vendedor&#125;/<span className="font-mono">{slugify(form.slug || form.nome) || "apelido"}</span>. Se deixar vazio, será gerado automaticamente a partir do nome do curso.
                </p>
              </div>
              <div className="space-y-2">
